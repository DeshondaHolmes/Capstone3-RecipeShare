...
//variables used to store HTML Data*/
...
// button container for like button
...
//variable for all posts
let allposts;


//on window.onload these functions will execute
window.onload = () => {

    //most like button on click fire this function mostLikedSort
    mostLikedButton.onclick = mostLikedSort;

    //button container  on click fire this function handleLikeButtonClick
    buttonContainer.onclick = handleLikeButtonClick;

    //get all users when window finish loading 
    getAllPosts();
...
//function to know if user liked post
...
//function to handle like button on click
...
//fucntion to update like button
...
//function to post like to API 
function postLikeToApi() {
...
//function to delete post for a user 
